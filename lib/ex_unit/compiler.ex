defmodule Distributed.Compiler do
  @moduledoc false
  ...
  @compile {:no_warn_undefined, Distributed.ExUnit}
  ...
  def require_and_run(matched_test_files, test_paths, opts) do
    ...
    if test_files == [] do
      ...
      task = Distributed.ExUnit.async_run()
      ...
      try do
        ...
        %{failures: failures} = results = Distributed.ExUnit.await_run(task)
